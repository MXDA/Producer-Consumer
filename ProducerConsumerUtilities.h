...
typedef struct {
	sem_t mutex; //Used for accessing buffer in exclusive way, initial value is 1
	sem_t full; //Used to indicate the number of boxes in the buffer that filled with product
